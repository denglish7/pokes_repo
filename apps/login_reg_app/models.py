...
class UserManager(models.Manager):
    def register(self, data):
        ...
        elif not ONLY_LETTERS.match(data["alias"]):
        ...
        if not errors:
            new_user = self.create(first_name=data['first_name'], last_name=data['last_name'], alias=data['alias'], email=data['email'], password=hashed)
            response['added'] = True
